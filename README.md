...
Note: This was my first project beyond simple CLI programs. The code is messy, but I’m keeping it here for nostalgic reasons and to show where I started.
...
To try this game clone this repository and run `main.py` or download the .zip and run `FishingGame.exe`
...
When you hook onto a fish a circle will show up on the water, the circle's size is determined by the rarity of the fish. Keep your cursor within the circle while it moves around the water to catch the fish, the duration of this minigame is determined by the weight of the fish as bigger fish have more energy.
